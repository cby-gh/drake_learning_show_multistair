...
//get rpy slack vars for quaternion2euler constraints
const drake::solvers::VectorXDecisionVariable rpy_slack(int mode_index, int knot_index) const ;
  ...
  const drake::solvers::VectorXDecisionVariable input_vars(
    ...
    const drake::solvers::VectorXDecisionVariable floatfoot_collosionavoidence_rel_offset_vars0(int mode_index, int knot_index) const ;
    const drake::solvers::VectorXDecisionVariable floatfoot_collosionavoidence_rel_offset_vars1(int mode_index, int knot_index) const ;
    const drake::solvers::VectorXDecisionVariable floatfoot_collosionavoidence_rel_offset_vars2(int mode_index, int knot_index) const ;
    const drake::solvers::VectorXDecisionVariable floatfoot_pose_rel_offset_vars(int mode_index, int knot_index) const ;
 ...
 private:
  ...
  std::vector<drake::solvers::VectorXDecisionVariable> floatfoot_collosionavoidence_rel_offset_vars0_;
  std::vector<drake::solvers::VectorXDecisionVariable> floatfoot_collosionavoidence_rel_offset_vars1_;
  std::vector<drake::solvers::VectorXDecisionVariable> floatfoot_collosionavoidence_rel_offset_vars2_;
  std::vector<drake::solvers::VectorXDecisionVariable> rpy_slack_;
  std::vector<drake::solvers::VectorXDecisionVariable> floatfoot_pose_rel_offset_vars_;
};
